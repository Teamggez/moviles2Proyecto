...
class _ReporteFormularioScreenState extends State<ReporteFormularioScreen> {
  ...
  Future<void> _getCurrentLocation() async {
    setState(() {
      ...
      _locationAddress = "Obteniendo ubicación...";
    });
    ...
    try {
      ...
      if (!serviceEnabled) {
        ...
        if (mounted) {
          setState(() {
            _isLocationLoading = false;
            _locationAddress = "Servicios de ubicación desactivados";
          });
        }
        return;
      }
      ...
      if (mounted) {
        setState(() {
          ...
          _isLocationLoading = false;
          _locationAddress = "Ubicación obtenida correctamente";
        });
      }
      
      print("Ubicación obtenida: ${position.latitude}, ${position.longitude}");
    } catch (e) {
      print("Excepción al obtener ubicación: $e");
      if (mounted) {
        setState(() {
          _isLocationLoading = false;
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate() && _selectedCategory != null) {
      if (_currentPosition == null) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('No se pudo obtener la ubicación. Por favor, inténtalo de nuevo.')),
          );
        }
        return;
      }
      ...
      if (_selectedCategory == 'others' && _customTitleController.text.trim().isEmpty) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Por favor ingresa un título para el incidente')),
          );
        }
        return;
      }
      ...
      try {
        ...
        final reporteData = {
          ...
          'tipoNombre': categoryName,
          'tituloPersonalizado': _selectedCategory == 'others' ? _customTitleController.text.trim() : null,
  ...
  Widget _buildReportForm() {
    ...
    final bool isOthersCategory = _selectedCategory == 'others';
        ...
        child: ListView(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: selectedCategoryData['color'].withOpacity(0.1),
                borderRadius: BorderRadius.circular(12),
                border: Border.all(
                  color: selectedCategoryData['color'].withOpacity(0.3),
                  width: 1,
                ),
              ),
              child: Row(
            ...
            if (isOthersCategory) ...[
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  hintText: 'Ingresa un título para este tipo de incidente',
                  filled: true,
                ...
                validator: (value) {
                  if (isOthersCategory && (value == null || value.isEmpty)) {
                    return 'Por favor ingresa un título para el incidente';
                  }
                  return null;
                },
              ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    'Tu ubicación actual será utilizada para geolocalizar el incidente',
                    style: TextStyle(
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                hintText: 'Describe lo que está sucediendo con el mayor detalle posible...',
                filled: true,
                fillColor: Colors.grey[100],
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(12),
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      'Puedes usar la cámara o seleccionar de la galería',
                      style: TextStyle(
            ...
            Row(
              children: _riskLevels.entries.map((entry) {
                final isSelected = _riskLevel == entry.key;
                return Expanded(
                  child: GestureDetector(
                    onTap: () {
                      if (mounted) {
                        setState(() {
                          _riskLevel = entry.key;
                        });
                      }
                    },
                    child: Container(
