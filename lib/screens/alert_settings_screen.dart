...
class _AlertSettingsScreenState extends State<AlertSettingsScreen> {
  ...
  double _radioAlerta = 500.0; // metros
    ...
    try {
      ...
      if (userDoc.exists && mounted) {
        ...
        setState(() {
          ...
          _radioAlerta = (userData['radioAlerta'] ?? 500).toDouble();
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Recibe notificaciones automáticas cuando te acerques a reportes de riesgo en tu área.',
                  style: TextStyle(
                    color: Colors.blue.shade700,
                    fontSize: 14,
                  ),
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Container(
                          padding: const EdgeInsets.all(8),
                          decoration: BoxDecoration(
                            color: _notificacionesActivas ? Colors.green.shade100 : Colors.grey.shade100,
                            borderRadius: BorderRadius.circular(8),
                          ),
                          child: Icon(
                            _notificacionesActivas ? Icons.notifications_active : Icons.notifications_off,
                            color: _notificacionesActivas ? Colors.green.shade700 : Colors.grey.shade600,
                            size: 24,
                          ),
                        ),
                        const SizedBox(width: 16),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: _notificacionesActivas ? Colors.green.shade50 : Colors.grey.shade50,
                        borderRadius: BorderRadius.circular(8),
                        border: Border.all(
                          color: _notificacionesActivas ? Colors.green.shade200 : Colors.grey.shade300,
                        ),
                      ),
                      child: Text(
                        _notificacionesActivas
                            ? '✅ Recibirás alertas cuando te acerques a reportes de riesgo'
                            : '❌ No recibirás notificaciones de proximidad',
                        style: TextStyle(
                          color: _notificacionesActivas ? Colors.green.shade700 : Colors.grey.shade600,
                          fontSize: 14,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text('100m', style: TextStyle(color: Colors.grey[600], fontSize: 12)),
                        Text('2km', style: TextStyle(color: Colors.grey[600], fontSize: 12)),
                      ],
                    ),
                    const SizedBox(height: 12),
                    Container(
                      ...
                      child: Text(
                        'Recibirás alertas cuando estés a menos de ${_formatDistance(_radioAlerta)} de un reporte activo',
                        style: TextStyle(
                          color: Colors.blue.shade700,
                          fontSize: 14,
                        ),
                  ...
                  children: [
                    Row(
                      children: [
                        Container(
                          padding: const EdgeInsets.all(8),
                          decoration: BoxDecoration(
                            color: _sensibilidadColors[_sensibilidad]!.withOpacity(0.1),
                            borderRadius: BorderRadius.circular(8),
                          ),
                          child: Icon(
                            _sensibilidadIcons[_sensibilidad],
                            color: _sensibilidadColors[_sensibilidad],
                            size: 24,
                          ),
                        ),
                        const SizedBox(width: 16),
                    ...
                    ...(_sensibilidadOptions.map((option) {
                      ...
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          color: isSelected ? _sensibilidadColors[option]!.withOpacity(0.1) : null,
                          borderRadius: BorderRadius.circular(12),
                          border: Border.all(
                            color: isSelected ? _sensibilidadColors[option]! : Colors.grey.shade300,
                        ...
                        child: RadioListTile<String>(
                          title: Row(
                            children: [
                              Icon(
                                _sensibilidadIcons[option],
                                color: _sensibilidadColors[option],
                                size: 20,
                              ),
                              const SizedBox(width: 8),
                              Text(
                          ...
                          subtitle: Text(
                            _sensibilidadDescriptions[option]!,
                            style: TextStyle(
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Las notificaciones funcionan en segundo plano. Asegúrate de tener los permisos de ubicación activados.',
                      style: TextStyle(
